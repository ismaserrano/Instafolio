<article>
	...
	?>
        <header id="profile">
                <h2 style="position:relative;float:left;margin-bottom:20px !important;width:600px !important;"><?= $user->username; ?> profile</h2>
	...
	?>
	<h2>This user is not yet in Instafolio.<br />Do you want to talk about it?</h2>
