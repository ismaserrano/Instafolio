...
class ThumbnailComponent extends Component {
	...
	*/
	   ...
	   //load PhpThumb
	   App::import('Vendor', 'phpThumb', array("file"=>"phpThumb_1.7.9".DS."phpthumb.class.php"));
	   $phpThumb = new phpThumb();
	   
	   $output = 'jpeg';
	   if (strpos($source, 'png')){
	      $output = 'png';
	   }
	   ...
	   $phpThumb->config_output_format = $output;
